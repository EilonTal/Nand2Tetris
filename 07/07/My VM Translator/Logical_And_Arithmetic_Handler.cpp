...
Logical_And_Arithmetic_Handler::Logical_And_Arithmetic_Handler(string current_command,
                                                                ofstream &output_file, vector<string> tokens)
{
